    ...
    <>
      <header className="l-header">
        <nav className="nav bd-grid">
          <div>
            <a href="#home" className="nav__logo">SHUBHAM KASAR</a>
          </div>
      ...
      <main className="l-main">
        <section className="home bd-grid" id="home">
          <div className="home__data">
            <h1 className="home__title">Hi,I'am <br /><span className="home__title-color">Shubham</span><br /> Web designer</h1>
        ...
        <section className="about section " id="about">
          ...
          <div className="about__container bd-grid">
            ...
            <div>
              <h2 className="about__subtitle">I'am Shubham Kasar</h2>
...
span></div>
      ...
      <footer className="footer" id ="foter">
        <p className="footer__title">Shubham Kasar</p>
        <p className="footer__copy">&#169; Shubham Kasar <br></br>Contact : +91 9175913160<br></br>Address : Sanjivani College Of Engineering Kopargaon</p>
      </footer>
    </>
  );
}
